...
[CreateAssetMenu(fileName = "Rule3TSO", menuName = "Rules/Rule3TSO")]
public class Rule3TSO : RuleSO
{
    public override bool IsValid(Dictionary<SocketType, List<SocketType>> connections)
    {
        ...
        Debug.Log($"Rule3TSO - A libre ({freeA}) conectado a P libre ({freeP}): {(result ? "Cumplida" : "No cumplida")}");
